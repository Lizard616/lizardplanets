...
templates:
  - template: Planetary Overview
    ...
    atmospheric_color: Orange
    atmospheric_composition: N₂, O₂, CO₂, H₂S
    atmospheric_toxicity: Breathable
    atmospheric_pressure: 1.2 atm
    class: Terrestrial Exomoon
    climate: Tropical
    diameter: 12,074 km
    esi: 0.933
    galaxy: '[Absthaca Galaxy](/celestial-objects/galaxies/spiral/absthaca-galaxy/) (formerly) [Elkska Galaxy](/celestial-objects/galaxies/spiral/elkska-galaxy/) (current)'
    government: Stable (Whirlwinds)
    gravity: 0.93 g (9.1201845 m/s²)
    languages_spoken:
      - English (primary)
      - Russian (possible alternative)
      - French (possible alternative)
    mass: 0.83 Earths
    orbital_period: 7.4 days
    other_notes: Home to the [Whirlwinds](/characters/species/main-races/whirlwinds/)
    primary_core_element: Fe, Ni
    rotation_period: 7.4 days
    sea_composition: H₂O
    semimajor_axis: 756,322 km
    solar_day: 7.4 days (1:1)
    strength: 32 µT
    suns: 2
    system: Lizard-595
    temperature: 65℉
