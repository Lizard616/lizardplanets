...
templates:
  - template: Planetary Overview
    ...
    atmospheric_composition: N<sub>2</sub>, O<sub>2</sub>
    ...
    gravity: 0.82 <i>g</i> (8.041453 m/s²)
    languages_spoken: English, Chinese, Japanese
    mass: 0.26 earths
    sea_composition: H<sub>2</sub>O
    suns: '1'
    water_state: Liquid
---

{{planetaryoverview:Talos-II}}
***Talos-II*** is a natural satellite of the gas giant named Talos. It is the world that serves as the primary settings of Arknights: Endfield.
